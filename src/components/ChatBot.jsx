...
export default function Chatbot() {
  const [messages, setMessages] = useState([
    { role: "assistant", content: "Olá! Para começar, me fale um pouco sobre o sistema que você deseja desenvolver." }
  ]);
  ...
  return (
    <div className="w-1/2 mx-auto rounded-lg border border-stroke bg-white shadow-lg dark:border-transparent dark:bg-[#2C303B]">
